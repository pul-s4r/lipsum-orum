...
import { Diagram, DiagramEvents, DiagramType, IAutoPlacement, IBaseCoords, IShapeToolbarConfig } from "../../ts-diagram";
...
export interface IDiagramEditorHandlersMap {
    ...
    [DiagramEditorEvents.beforeLineTitleMove]: (event: MouseEvent, lineId: Id, titleId: Id, coord: IBaseCoords) => boolean | void;
    [DiagramEditorEvents.afterLineTitleMove]: (event: MouseEvent, lineId: Id, titleId: Id, coord: IBaseCoords) => void;
    [DiagramEditorEvents.lineTitleMoveEnd]: (event: MouseEvent, lineId: Id, titleId: Id, coord: IBaseCoords) => void;
    ...
    [DiagramEditorEvents.beforeItemMove]: (event: MouseEvent, id: Id, coord: IBaseCoords, $mov: ICoords) => boolean | void;
